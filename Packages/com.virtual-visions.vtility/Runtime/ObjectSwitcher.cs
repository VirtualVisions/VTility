...
namespace VirtualVisions.VTility
{
    ...
    public abstract class ObjectSwitcher : DataList
    {
        ...
        public static ObjectSwitcher Create(GameObject[] objs)
        {
            ...
            values[(int)ObjectSwitcher_Values.OnObjectSwitched] = UdonAction.Create();
            values[(int)ObjectSwitcher_Values.IsComponentList] = false;
            values[(int)ObjectSwitcher_Values.ComponentList] = new DataList();
            values[(int)ObjectSwitcher_Values.OnComponentSwitched] = UdonAction.Create();
    ...
    public static class ObjectSwitchers
    {
        ...
        public static UdonAction OnObjectSwitched(this ObjectSwitcher switcher) =>
            switcher[(int)ObjectSwitcher_Values.OnObjectSwitched].AsUdonAction();

        public static UdonAction OnComponentSwitched(this ObjectSwitcher switcher) =>
            switcher[(int)ObjectSwitcher_Values.OnComponentSwitched].AsUdonAction();
